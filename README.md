...
7. [**Conventions**](https://github.com/mareszhar/hail-styl/blob/main/docs/conventions.md) — Naming conventions for utils, variables, and tokens. [[get raw]](https://raw.githubusercontent.com/mareszhar/hail-styl/main/docs/conventions.md)
8. [**Integrations**](https://github.com/mareszhar/hail-styl/blob/main/docs/integrations.md) — Setup guides for Vite/Nuxt and behaviors worth knowing. [[get raw]](https://raw.githubusercontent.com/mareszhar/hail-styl/main/docs/integrations.md)
